...
export default function LogoMark({ size = 36, className = "" }: { size?: number; className?: string }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" aria-hidden="true" className={className}>
      <rect x="0.75" y="0.75" width="22.5" height="22.5" rx="6.5" fill="var(--color-ink)" stroke="var(--color-primary)" strokeWidth="1.4" />
      <path
      ...
      />
      <circle cx="18.6" cy="5.4" r="1.3" fill="var(--color-primary)" />
      <defs>
